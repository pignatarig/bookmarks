...
RSpec.describe BookmarksController, type: :controller do
  ...
  let(:invalid_attributes) {
    attributes_for(:bookmark_with_title_only)
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        attributes_for(:edited_bookmark)
      }
      ...
      it "updates the requested bookmark" do
        ...
        bookmark.reload
        expect(bookmark.title).to eq new_attributes[:title]
        expect(bookmark.url).to eq new_attributes[:url]
        expect(bookmark.form_tags).to eq new_attributes[:form_tags]
      end
